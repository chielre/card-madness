        ...
        <div>
            ...
            <div class="flex items-center">
                ...
                <div class="-ml-6 bg-[#2b0246]  grid grid-cols-5 gap-8 w-3xl border-4 backdrop-blur-sm rounded-xl border-black p-6 transition-all">
                    ...
                    <div v-for="player in lobby.players" class="madness-card card-back card-responsive card-white">Seriously? You think we didnt suspect you would try this?</div>
                </div>
            </div>
            <div class="absolute bottom-0 left-0 right-0 flex justify-center ">
                <div ref="handRef" class="flex gap-2 z-10 relative">
                    <div v-for="white_card in lobby.getCurrentPlayerCards()" class="madness-card card-white card-sm draggable-card">{{ white_card.text }}</div>
